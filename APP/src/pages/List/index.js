...
import { List, Menu, Layout } from "antd";
          ...
          <Sider>
            ...
            >
              {this.state.menu.map(item => (
                <Menu.Item key={item.path}>{item.text}</Menu.Item>
              ))}
            </Menu>
          </Sider>
              ...
              <List itemLayout="horizontal">
                {this.state.datalist.map(goods => {
                  return (
                    <List.Item
                      key={goods.goods_id}
                      onClick={this.gotoGoods.bind(this, goods.goods_id)}
                    >
                      <List.Item.Meta
                        avatar={
                          <img
                            src={goods.goods_image_url}
